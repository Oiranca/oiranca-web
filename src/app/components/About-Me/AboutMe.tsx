export const AboutMe = () => {
  return (
    ...
    >
      ...
      />
      <h1 className='order-2 text-4xl font-bold p-2 lg:order-1 lg:col-span-full lg:text-6xl'>
        Sobre mí
      </h1>
      <section className='order-3 flex flex-col font-semibold text-md text-justify p-1'>
        ...
        <p className='p-2'>
          ...
          donde ví C++, pero por capricho de la vida, mi camino no fue el de la
          programación, aunque siempre se quedó dentro de mí el no poder
          dedicarme a ello.
        </p>
        <p className='p-2'>
          Terminé un Ciclo Superior de Desarrollo de Aplicaciones
          Multiplataformas, el cual se ha centrado en adquirir conocimientos en
          lenguaje como Java, en base de datos SQL o framework como Android, al
          terminar he podido realizar las prácticas de empresa en Lean Mind .
        </p>
        <p className='p-2'>
          Para introducirme en Frontend he realizado varios cursos y un bootcamp
          donde he podido adquirir conocimientos de JavaScript, TypeScript,
          Angular, HTML5, CSS3 y React.
        </p>
      </section>
    </div>
  );
